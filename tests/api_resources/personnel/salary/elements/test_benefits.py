...
class TestBenefits:
    ...
    def test_method_create(self, client: SDK4human) -> None:
        benefit = client.personnel.salary.elements.benefits.create(
            amount="50.2",
            currency="NOK",
        ...
        assert_matches_type(BenefitCreateResponse, benefit, path=["response"])
    ...
    def test_raw_response_create(self, client: SDK4human) -> None:
        response = client.personnel.salary.elements.benefits.with_raw_response.create(
            amount="50.2",
            currency="NOK",
            description="Hourly salary",
            external_id="ext-22",
    ...
    def test_streaming_response_create(self, client: SDK4human) -> None:
        with client.personnel.salary.elements.benefits.with_streaming_response.create(
            amount="50.2",
            currency="NOK",
            description="Hourly salary",
            external_id="ext-22",
    ...
    def test_method_retrieve(self, client: SDK4human) -> None:
        benefit = client.personnel.salary.elements.benefits.retrieve(
            0,
        )
        assert_matches_type(BenefitRetrieveResponse, benefit, path=["response"])

    @parametrize
    def test_raw_response_retrieve(self, client: SDK4human) -> None:
        response = client.personnel.salary.elements.benefits.with_raw_response.retrieve(
            0,
        )
    ...
    def test_streaming_response_retrieve(self, client: SDK4human) -> None:
        with client.personnel.salary.elements.benefits.with_streaming_response.retrieve(
            0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_update(self, client: SDK4human) -> None:
        benefit = client.personnel.salary.elements.benefits.update(
            0,
        )
        assert_matches_type(BenefitUpdateResponse, benefit, path=["response"])
    ...
    def test_raw_response_update(self, client: SDK4human) -> None:
        response = client.personnel.salary.elements.benefits.with_raw_response.update(
            0,
        )
    ...
    def test_streaming_response_update(self, client: SDK4human) -> None:
        with client.personnel.salary.elements.benefits.with_streaming_response.update(
            0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_list(self, client: SDK4human) -> None:
        benefit = client.personnel.salary.elements.benefits.list()
        assert_matches_type(BenefitListResponse, benefit, path=["response"])
    ...
    def test_raw_response_list(self, client: SDK4human) -> None:
        response = client.personnel.salary.elements.benefits.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: SDK4human) -> None:
        with client.personnel.salary.elements.benefits.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncBenefits:
    ...
    async def test_method_create(self, async_client: AsyncSDK4human) -> None:
        benefit = await async_client.personnel.salary.elements.benefits.create(
            amount="50.2",
            currency="NOK",
            description="Hourly salary",
            external_id="ext-22",
    ...
    async def test_raw_response_create(self, async_client: AsyncSDK4human) -> None:
        response = await async_client.personnel.salary.elements.benefits.with_raw_response.create(
            amount="50.2",
            currency="NOK",
            description="Hourly salary",
            external_id="ext-22",
    ...
    async def test_streaming_response_create(self, async_client: AsyncSDK4human) -> None:
        async with async_client.personnel.salary.elements.benefits.with_streaming_response.create(
            amount="50.2",
            currency="NOK",
            description="Hourly salary",
            external_id="ext-22",
    ...
    async def test_method_retrieve(self, async_client: AsyncSDK4human) -> None:
        benefit = await async_client.personnel.salary.elements.benefits.retrieve(
            0,
        )
        assert_matches_type(BenefitRetrieveResponse, benefit, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncSDK4human) -> None:
        response = await async_client.personnel.salary.elements.benefits.with_raw_response.retrieve(
            0,
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncSDK4human) -> None:
        async with async_client.personnel.salary.elements.benefits.with_streaming_response.retrieve(
            0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_update(self, async_client: AsyncSDK4human) -> None:
        benefit = await async_client.personnel.salary.elements.benefits.update(
            0,
        )
        assert_matches_type(BenefitUpdateResponse, benefit, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncSDK4human) -> None:
        response = await async_client.personnel.salary.elements.benefits.with_raw_response.update(
            0,
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncSDK4human) -> None:
        async with async_client.personnel.salary.elements.benefits.with_streaming_response.update(
            0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_list(self, async_client: AsyncSDK4human) -> None:
        benefit = await async_client.personnel.salary.elements.benefits.list()
        assert_matches_type(BenefitListResponse, benefit, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncSDK4human) -> None:
        response = await async_client.personnel.salary.elements.benefits.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncSDK4human) -> None:
        async with async_client.personnel.salary.elements.benefits.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
