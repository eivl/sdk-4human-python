...
class TestHistory:
    ...
    def test_method_list(self, client: SDK4human) -> None:
        history = client.personnel.profiles.history.list(
            "string",
        )
    ...
    def test_raw_response_list(self, client: SDK4human) -> None:
        response = client.personnel.profiles.history.with_raw_response.list(
            "string",
        )
    ...
    def test_streaming_response_list(self, client: SDK4human) -> None:
        with client.personnel.profiles.history.with_streaming_response.list(
            "string",
        ) as response:
    ...
    def test_path_params_list(self, client: SDK4human) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `user_id` but received ''"):
            client.personnel.profiles.history.with_raw_response.list(
                "",
            )
...
class TestAsyncHistory:
    ...
    async def test_method_list(self, async_client: AsyncSDK4human) -> None:
        history = await async_client.personnel.profiles.history.list(
            "string",
        )
        assert_matches_type(HistoryListResponse, history, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncSDK4human) -> None:
        response = await async_client.personnel.profiles.history.with_raw_response.list(
            "string",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncSDK4human) -> None:
        async with async_client.personnel.profiles.history.with_streaming_response.list(
            "string",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncSDK4human) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `user_id` but received ''"):
            await async_client.personnel.profiles.history.with_raw_response.list(
                "",
            )
