...
from sdk_minus_4human.types.personnel.company_employees import (
...
class TestCustomFieldsByName:
    ...
    def test_method_update(self, client: SDK4human) -> None:
        custom_fields_by_name = client.personnel.company_employees.custom_fields_by_name.update(
            "string",
        )
    ...
    def test_raw_response_update(self, client: SDK4human) -> None:
        response = client.personnel.company_employees.custom_fields_by_name.with_raw_response.update(
            "string",
        )
    ...
    def test_streaming_response_update(self, client: SDK4human) -> None:
        with client.personnel.company_employees.custom_fields_by_name.with_streaming_response.update(
            "string",
        ) as response:
    ...
    def test_path_params_update(self, client: SDK4human) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `company_employee_id` but received ''"):
            client.personnel.company_employees.custom_fields_by_name.with_raw_response.update(
                "",
            )
...
class TestAsyncCustomFieldsByName:
    ...
    async def test_method_update(self, async_client: AsyncSDK4human) -> None:
        custom_fields_by_name = await async_client.personnel.company_employees.custom_fields_by_name.update(
            "string",
        )
        assert_matches_type(CustomFieldsByNameUpdateResponse, custom_fields_by_name, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncSDK4human) -> None:
        response = await async_client.personnel.company_employees.custom_fields_by_name.with_raw_response.update(
            "string",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncSDK4human) -> None:
        async with async_client.personnel.company_employees.custom_fields_by_name.with_streaming_response.update(
            "string",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_update(self, async_client: AsyncSDK4human) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `company_employee_id` but received ''"):
            await async_client.personnel.company_employees.custom_fields_by_name.with_raw_response.update(
                "",
            )
