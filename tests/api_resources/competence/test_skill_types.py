...
class TestSkillTypes:
    ...
    def test_method_list(self, client: SDK4human) -> None:
        skill_type = client.competence.skill_types.list()
        assert_matches_type(SkillTypeListResponse, skill_type, path=["response"])
    ...
    def test_raw_response_list(self, client: SDK4human) -> None:
        response = client.competence.skill_types.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: SDK4human) -> None:
        with client.competence.skill_types.with_streaming_response.list() as response:
...
class TestAsyncSkillTypes:
    ...
    async def test_method_list(self, async_client: AsyncSDK4human) -> None:
        skill_type = await async_client.competence.skill_types.list()
        assert_matches_type(SkillTypeListResponse, skill_type, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncSDK4human) -> None:
        response = await async_client.competence.skill_types.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncSDK4human) -> None:
        async with async_client.competence.skill_types.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
