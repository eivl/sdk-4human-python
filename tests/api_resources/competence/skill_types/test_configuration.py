...
class TestConfiguration:
    ...
    def test_method_list(self, client: SDK4human) -> None:
        configuration = client.competence.skill_types.configuration.list()
    ...
    def test_raw_response_list(self, client: SDK4human) -> None:
        response = client.competence.skill_types.configuration.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: SDK4human) -> None:
        with client.competence.skill_types.configuration.with_streaming_response.list() as response:
...
class TestAsyncConfiguration:
    ...
    async def test_method_list(self, async_client: AsyncSDK4human) -> None:
        configuration = await async_client.competence.skill_types.configuration.list()
        assert_matches_type(ConfigurationListResponse, configuration, path=["response"])

    @parametrize
    async def test_raw_response_list(self, async_client: AsyncSDK4human) -> None:
        response = await async_client.competence.skill_types.configuration.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncSDK4human) -> None:
        async with async_client.competence.skill_types.configuration.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
