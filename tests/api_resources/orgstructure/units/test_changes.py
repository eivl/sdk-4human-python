...
class TestChanges:
    ...
    def test_method_list(self, client: SDK4human) -> None:
        change = client.orgstructure.units.changes.list(
            from_=0,
            to=0,
        )
    ...
    def test_raw_response_list(self, client: SDK4human) -> None:
        response = client.orgstructure.units.changes.with_raw_response.list(
            from_=0,
            to=0,
        )
    ...
    def test_streaming_response_list(self, client: SDK4human) -> None:
        with client.orgstructure.units.changes.with_streaming_response.list(
            from_=0,
            to=0,
        ) as response:
...
class TestAsyncChanges:
    ...
    async def test_method_list(self, async_client: AsyncSDK4human) -> None:
        change = await async_client.orgstructure.units.changes.list(
            from_=0,
            to=0,
        )
        assert_matches_type(ChangeListResponse, change, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncSDK4human) -> None:
        response = await async_client.orgstructure.units.changes.with_raw_response.list(
            from_=0,
            to=0,
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncSDK4human) -> None:
        async with async_client.orgstructure.units.changes.with_streaming_response.list(
            from_=0,
            to=0,
        ) as response:
            assert not response.is_closed
