...
class TestLocations:
    ...
    def test_method_list(self, client: SDK4human) -> None:
        location = client.orgstructure.companies.locations.list(
            "string",
        )
    ...
    def test_raw_response_list(self, client: SDK4human) -> None:
        response = client.orgstructure.companies.locations.with_raw_response.list(
            "string",
        )
    ...
    def test_streaming_response_list(self, client: SDK4human) -> None:
        with client.orgstructure.companies.locations.with_streaming_response.list(
            "string",
        ) as response:
    ...
    def test_path_params_list(self, client: SDK4human) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `company_id` but received ''"):
            client.orgstructure.companies.locations.with_raw_response.list(
                "",
            )
...
class TestAsyncLocations:
    ...
    async def test_method_list(self, async_client: AsyncSDK4human) -> None:
        location = await async_client.orgstructure.companies.locations.list(
            "string",
        )
        assert_matches_type(LocationListResponse, location, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncSDK4human) -> None:
        response = await async_client.orgstructure.companies.locations.with_raw_response.list(
            "string",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncSDK4human) -> None:
        async with async_client.orgstructure.companies.locations.with_streaming_response.list(
            "string",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncSDK4human) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `company_id` but received ''"):
            await async_client.orgstructure.companies.locations.with_raw_response.list(
                "",
            )
