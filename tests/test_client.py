...
from sdk_minus_4human import SDK4human, AsyncSDK4human, APIResponseValidationError
from sdk_minus_4human._models import BaseModel, FinalRequestOptions
from sdk_minus_4human._constants import RAW_RESPONSE_HEADER
from sdk_minus_4human._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from sdk_minus_4human._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: SDK4human | AsyncSDK4human) -> int:
...
class TestSdk4human:
    client = SDK4human(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "sdk_minus_4human/_legacy_response.py",
                        "sdk_minus_4human/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "sdk_minus_4human/_compat.py",
    ...
    def test_multipart_repeating_array(self, client: SDK4human) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(SDK_4HUMAN_BASE_URL="http://localhost:5000/from/env"):
            client = SDK4human(bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: SDK4human) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: SDK4human) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: SDK4human) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = SDK4human(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = SDK4human(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    @mock.patch("sdk_minus_4human._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        ...
        with pytest.raises(APITimeoutError):
            self.client.post(
                ...
                body=cast(
                    object,
                    dict(email="REPLACE_ME", first_name="REPLACE_ME", language="REPLACE_ME", last_name="REPLACE_ME"),
                ),
...
class TestAsyncSdk4human:
    client = AsyncSDK4human(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, async_client: AsyncSDK4human) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(SDK_4HUMAN_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncSDK4human(bearer_token=bearer_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncSDK4human) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncSDK4human) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncSDK4human) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncSDK4human(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncSDK4human(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
