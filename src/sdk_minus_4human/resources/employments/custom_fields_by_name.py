...
from ...types.employments import custom_fields_by_name_update_params
from ...types.employments.custom_fields_by_name_update_response import CustomFieldsByNameUpdateResponse
...
class CustomFieldsByNameResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._put(
            f"/personnel/employments/{employment_id}/custom-fields-by-name",
