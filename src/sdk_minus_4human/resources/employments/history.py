...
from ...types.employments import history_retrieve_params
from ...types.employments.history_retrieve_response import HistoryRetrieveResponse
...
class HistoryResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        This endpoint allows to get snapshots of employment from a given period of time.
        Additionally data may be filtered out by validity date, snapshot type, and
        creation time.
        ...
        """
        return self._get(
            f"/personnel/employments/{employment_id}/history",
