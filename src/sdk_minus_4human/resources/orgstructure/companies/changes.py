...
from ....types.orgstructure.companies import change_list_params
from ....types.orgstructure.companies.change_list_response import ChangeListResponse
...
class ChangesResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        """
        Get the list of all changes made to organization unit type company.
        ...
        Args:
          ...
          to: Maximum date of changes, could be timestamp or date (YYYY-MM-DD) or dateTime in
              ISO 8601 (Y-m-d\\TTH:i:sP) depending on selected `format`
        ...
        return cast(
            ChangeListResponse,
            self._get(
                "/orgstructure/companies/changes",
