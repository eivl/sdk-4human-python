...
from ....types.personnel.employments.configuration_list_response import ConfigurationListResponse
...
class ConfigurationResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        """This endpoint allows to get fields required for employment creation.

        Each
        instance may have different fields required for this process depends on field
        configuration in system.
        """
        return self._get(
            "/personnel/employments/configuration",
