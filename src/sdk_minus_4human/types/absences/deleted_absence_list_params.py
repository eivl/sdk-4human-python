...
__all__ = ["DeletedAbsenceListParams"]


class DeletedAbsenceListParams(TypedDict, total=False):
    ...
    """Filters absences by employee ID (UUID).

    Employee ID refers to the employee that the absence is created for.
    """
    ...
    Allowed values are for_approval, approved, rejected.
    """
